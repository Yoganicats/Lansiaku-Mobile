...
class TemudokterActivity  : AppCompatActivity() {
    ...
    private var recyclerViewSpesialisAdapter: AdapterTemuDokterSpesialis? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById<View>(R.id.rvSpesialisListsTemuDokter) as RecyclerView
        recyclerViewSpesialisAdapter = AdapterTemuDokterSpesialis(this@TemudokterActivity,spesialisList)
        val layoutManager: RecyclerView.LayoutManager = GridLayoutManager(this, 2)
        recyclerView!!.layoutManager = layoutManager
        recyclerView!!.adapter = recyclerViewSpesialisAdapter

        recyclerViewSpesialisAdapter?.onItemClick= {
            val intent = Intent(this, FasilitasKesehatanActivity::class.java)
